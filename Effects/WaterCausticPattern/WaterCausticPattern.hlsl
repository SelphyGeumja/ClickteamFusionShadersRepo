...
PS_OUTPUT ps_main(in PS_INPUT In)
{
    ...
    Out.Color = float4(intensity, intensity, intensity, In.Tint.a);
    Out.Color.rgb *= In.Tint.rgb;
    return Out;
}
...
PS_OUTPUT ps_main_pm(in PS_INPUT In)
{
    ...
    float a = In.Tint.a;
    Out.Color = float4(intensity * In.Tint.r * a,
                       intensity * In.Tint.g * a,
                       intensity * In.Tint.b * a,
                       a);
    return Out;
}
